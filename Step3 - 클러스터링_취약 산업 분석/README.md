...
7. [4️⃣ 일반유통-전문서비스 클러스터링](#3️⃣-일반유통-전문서비스-클러스터링)
...
- 특수교통: 항공, 철도, 화물운소업, 여객선
- 월납/세금: 월납/세금
- 그 외 서비스: 사회단체, 세탁소, 사진, 농기구, 장비대여, 열쇠/도장 등

## 4️⃣ 일반유통-전문서비스 클러스터링
- 종합유통-생활서비스와 마찬가지로 하위 분류가 너무 많아 분리해서 진행하였다.

### 5️⃣ 일반유통 클러스터링
![image](https://user-images.githubusercontent.com/44918665/130340179-5360c028-d16a-4165-b89b-e47fdd58263d.png)
